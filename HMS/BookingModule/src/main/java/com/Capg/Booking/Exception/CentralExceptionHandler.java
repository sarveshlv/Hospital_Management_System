...
public class CentralExceptionHandler {
    ...
    @ExceptionHandler({ BookingNotFoundException.class, PatientNotFoundException.class, HospitalNotFoundException.class })
    ...
    @ExceptionHandler({ InvalidDatesException.class, InvalidBookingRequest.class, ParseException.class})
